...
import { MinerAdd } from "@features/MinerAdd";
import styles from './FlightSheetAdd.module.scss'
...
type FlightSheetAddProps = Omit<HTMLProps<HTMLDivElement>, typeof omittedProps[number]> & {
  onAdd?: () => void
  onSetup?: (refetchOptions: () => void) => void
}

export const FlightSheetAdd = (props: FlightSheetAddProps) => { 
  ...
  const modalAddCryptocurrency = useAddModal('Add cryptocurrency', 'create-flightsheet-create-crypto', CryptocurrencyAdd)
  const modalAddWallet = useAddModal('Add wallet', 'create-flightsheet-create-wallet', WalletAdd)
  const modalAddPool = useAddModal('Add pool', 'create-flightsheet-create-pool', PoolAdd)
  const modalAddMiner = useAddModal('Add miner', 'create-flightsheet-create-miner', MinerAdd)
