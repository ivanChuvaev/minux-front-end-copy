...
import styles from './MinerAdd.module.scss'
...
type MinerAddProps = Omit<HTMLProps<HTMLDivElement>, typeof omittedProps[number]> & {
  onAdd?: () => void
}
export const MinerAdd = (props: MinerAddProps) => {
