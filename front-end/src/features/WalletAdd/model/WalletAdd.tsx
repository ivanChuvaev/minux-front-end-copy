...
import styles from './WalletAdd.module.scss'
...
type WalletAddProps = Omit<HTMLProps<HTMLDivElement>, typeof omittedProps[number]> & {
  onAdd?: () => void
}

export const WalletAdd = (props: WalletAddProps) => {
