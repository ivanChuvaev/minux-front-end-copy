...
import styles from './CryptocurrencyAdd.module.scss'
...
type CryptocurrencyAddProps = Omit<HTMLProps<HTMLDivElement>, typeof omittedProps[number]> & {
  onAdd?: () => void
}

export const CryptocurrencyAdd = (props: CryptocurrencyAddProps) => {
